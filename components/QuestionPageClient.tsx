...
import { ArrowLeft, Play, Share2, RotateCcw, Lightbulb, MessageSquare, CheckCircle, XCircle, Home, ChevronRight, Sparkles } from 'lucide-react'
          ...
          <div className="card">
            <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
              ...
              <div className="flex items-center gap-2 mt-3">
                <MarkCompleteButton questionId={question.id} />
